                ...
                <div class="col-lg-6">
                    <form class="border-box p-4" action="{{route('payment.submit')}}" id="payment-form" method="POST">
                        ...
                        <div class="form-group mt-4">
                            ...
                            class="form-control mb-2 StripeElement StripeElement--empty @error('name') border border-danger @enderror" 
                        ...
                        {{-- adress line 1 --}}
                        <div class="form-group">
                            <input type="text" name="line1" id="line1" maxlength="70"
                            class="form-control mb-2 StripeElement StripeElement--empty @error('line1') border border-danger @enderror" 
                            placeholder="Address line 1" value="{{old('line1')}}">
                            @error('line1')
                            <div class=" text-danger ">
                                *{{$message}}
                            </div>
                        ...
                        <!-- buttons -->
                        <div class="p-4 bg-gray col-12">
                            <button type="submit" class="btn btn-primary">Pay</button>
                            <a href="{{route('order.details',$order[0]->id)}}" class="btn btn-dark btn-block">Back</a>
                        </div>
                    </form>
                </div>
                {{-- order summary --}}
                    ...
                    <div class="border-box p-4">
                        ...
                        <ul class="list-unstyled">
                            <li class="d-flex justify-content-between">
                                <span>Subtotal</span>
                                <span>
                                    ${{round($order[0]->total_price/1.10-9.99,2)}}
                                </span>
                            </li>
                            <li class="d-flex justify-content-between">
                                <span>Shipping &amp; Handling</span>
                                <span>${{$order[0]->delivery_price}}</span>
                            </li>
                            <li class="d-flex justify-content-between">
                                <span>Estimated Tax</span>
                                <span>${{round(($order[0]->total_price/1.1)*0.1,2)}}</span>
                            </li>
                        </ul>
                        <hr>
                        <div class="d-flex justify-content-between">
                            <span>Total</span>
                            <strong>${{$order[0]->total_price}}</strong> 
                        </div>
                    </div>
                </div>
            </div>
