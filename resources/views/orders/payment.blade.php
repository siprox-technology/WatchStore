...
@section('content')
        ...
        <div class="main-wrapper">
                        ...
                        <form action="{{route('payment.submit')}}" id="payment-form" method="POST">
                            ...
                            @enderror
                            <!-- order info -->
                            <span>$<input type="text" name="amount" class="form-control mb-3 StripeElement StripeElement--empty" id="amount_for_payment" value="{{Session::get('cart')->totalPrice}}" readonly></span>            
