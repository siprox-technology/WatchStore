                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="list-inline dashboard-menu text-center">
                                    <li class="list-inline-item m-1"><a class="active" href="">Profile
                                            Details</a></li>
                                    <li class="list-inline-item m-1"><a href="dashboard.html">Change password</a></li>
                                    <li class="list-inline-item m-1"><a href="address.html">Address</a></li>
                                    <li class="list-inline-item m-1"><a href="order.html">Basket</a></li>
                                    <li class="list-inline-item m-1"><a href="order.html">Orders</a></li>
                                    <li class="list-inline-item m-1"><a href="order.html">Contact method</a></li>
                                </ul>
